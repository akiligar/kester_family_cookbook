...
website:
  ...
  canonical_url: https://cookbook.connellkesters.com/recipes/main-dishes/grilled-flank-steak-chimichurri/
...
This dinner is designed to become Chimichurri Steak Salad for a cold work-box meal.
...
1. Slice the remaining steak thinly against the grain.
2. Chop the romaine.
3. Dice the cucumber.
4. Thinly slice the red onion.
5. Pack the vegetables separately if possible.
6. Pack a small container of chimichurri.
7. Pack feta separately if using.

### At Work / At 2:00 AM

1. Toss the vegetables together.
2. Top with the sliced steak.
3. Spoon chimichurri over the salad.
4. Add feta if desired.

## Make-Ahead Notes

- Chimichurri can be made several hours ahead.
- The steak can be seasoned shortly before grilling.

## Storage and Leftovers

- Refrigerate steak and chimichurri separately for up to 4 days.
- Chimichurri develops more flavor overnight.
- Keep salad vegetables separate until serving.
...
This is a useful summer grilling meal because it is simple, flavorful, and intentionally produces a strong cold work-box meal the next day.
...
- YYYY-MM-DD: Note whether Chimichurri Steak Salad worked as a cold work-box meal.

## What Matters

- Always slice flank steak against the grain.
- Reserve steak and chimichurri intentionally if the salad transformation is planned.
- Keep salad vegetables separate until serving.
